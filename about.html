...
<div class="about-content">
    ...
    <ul>
        ...
        <li><strong>Author Identification:</strong> Every piece of writing on our platform is officially published with the author's name and scientific status clearly credited.</li>
    </ul>

    <h3>Call for Authors</h3>
    <p>We welcome submissions from anyone with a passion for physics. If you have an interesting scientific finding or theoretical proposition, we invite you to send them to us.</p>

    <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #eee;">
        <p><strong>Contact Us:</strong></p>
        <p>📧 <a href="mailto:yusifmammedov001@gmail.com">yusifmammedov001@gmail.com</a></p>
        <p>📞 +994 51 533 04 17</p>
    </div>
</div>
